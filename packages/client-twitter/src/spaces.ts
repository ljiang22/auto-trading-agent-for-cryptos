...
// Temporary type definitions until types are exported
type SpaceConfig = any;
type SpeakerRequest = any;
    ...
    try {
        const context = composeContext({
            state: { 
                ...
                lore: Array.isArray(runtime.character.lore) ? runtime.character.lore.join("\n") : runtime.character.lore || "",
                messageDirections: "",
                postDirections: "",
                roomId: "temp-room-id" as any,
                actors: "",
                recentMessages: "",
                recentMessagesData: []
            },
