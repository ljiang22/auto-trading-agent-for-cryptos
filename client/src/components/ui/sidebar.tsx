            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className={cn(
                            "flex mr-4 group-data-[collapsible=icon]:mr-0 border w-full flex-col min-h-0 overflow-y-auto group-data-[variant=floating]:rounded-md group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow",
