...
SMALL_GOOGLE_MODEL= # Default: gemini-3.1-flash-lite-preview
MEDIUM_GOOGLE_MODEL= # Default: gemini-3.1-flash-lite-preview
LARGE_GOOGLE_MODEL= # Default: gemini-3.1-pro-preview
EMBEDDING_GOOGLE_MODEL= # Default: text-embedding-004
GOOGLE_VERTEX_PROJECT= # GCP project (Vertex AI)
